...
<template>
    <div>
        <InputNumber :max="1000000000" :min="1" v-model="value1" :formatter="formatter" :parser="parser"
                     @on-change="change" style="width: 200px"></InputNumber>
        <InputNumber :max="1000000000" :min="1" v-model="value2" :formatter="formatter2" :parser="parser2"
                     @on-change="change" style="width: 200px"></InputNumber>

        <InputNumber placeholder="hhhhh" :show-handler="true" @on-change="change" style="width: 200px"></InputNumber>

        <InputNumber placeholder="hhhhh" show-handler="hover" v-model="valueNull" @on-change="change"
